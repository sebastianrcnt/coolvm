...
A 16-bit educational CPU architecture (cool16) with assembler, disassembler, and VM — implemented in TypeScript/Bun.
...
> _"What if we designed a 16-bit CPU in 2026, knowing everything we know now?"_
...
_cool16 v1.1 - designed for clarity, consistency, and teachability._
